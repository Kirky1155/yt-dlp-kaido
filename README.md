This is a extractor plugin for [yt-dlp](https://github.com/yt-dlp/yt-dlp) that enables downloading content from [Kaido]([https://kaido.to]).
...
```bash
python -m pip install -U [[https://github.com/pratikpatel8982/yt-dlp-hianime/archive/master.zip](https://github.com/Kirky1155/yt-dlp-kaido.git)](https://github.com/Kirky1155/yt-dlp-kaido/archive/refs/heads/master.zip)
```
